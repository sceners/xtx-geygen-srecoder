...
mov hBrush,eax
invoke ImageButton,hWnd,106,352,501,502,501,GenBtn
invoke ImageButton,hWnd,12,352,601,602,601,AboutBtn
invoke ImageButton,hWnd,231,352,701,702,701,ExitBtn
mov hGen,eax
...
;invoke MessageBox,hWnd,addr AboutTxt,addr AboutCap,MB_ICONINFORMATION or MB_OK	
...
Wm_2:
		 ...
		 call	Draw_Scroller                                             ;|
             ...
             ;*****************************************************************************=
                                                                                          ;|
               invoke	RedrawWindow, [hWnd], 0, 0,   RDW_INVALIDATE OR RDW_UPDATENOW OR  RDW_NOCHILDREN      ;evite les clignotement                       ;| 
                                                                                          ;|
Wm_3:                                                                                     ;|
	       cmp [uMsg],WM_PAINT                                                          ;|
             jnz Wm_4                                                                     ;|
...
mov ebx,PosRect.top
add ebx, 40
invoke MoveWindow,hWnd,eax,ebx,301,77,TRUE
